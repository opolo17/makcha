    ...
    >
      <main className="flex flex-1 flex-col px-5 pb-36 pt-8">
        ...
        <section className="text-center">
          ...
          <p
            className={`mt-3 font-black tabular-nums tracking-tighter ${
              isLate
                ? "font-impact text-4xl text-red-300"
                : "font-timer text-7xl sm:text-8xl"
            }`}
            aria-live="polite"
            aria-atomic="true"
          >
        ...
        <section className="mt-8 rounded-2xl border border-white/15 bg-black/20 px-4 py-4 backdrop-blur-sm">
          <p className="text-center font-impact text-lg font-bold leading-snug text-white">
            {pressureCopy}
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          {routeData.timeline.length > 0 ? (
            ...
            <p className="text-sm text-white/60">경로 정보를 불러오지 못했습니다.</p>
          )}
        </section>
